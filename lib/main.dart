  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Hello, Hoanganh', style: TextStyle(fontSize: 18),),
        centerTitle: true,
                      ...
                      child: Row(
                        ...
                        children: [
                          TextButton.icon(
                            ...
                            label: const Text('Location', style: TextStyle(color: Colors.black, fontSize: 16),),
                            style: ButtonStyle(
                      ...
                      child: Row(
                        ...
                        children: [
                          TextButton.icon(
                            ...
                            label: const Text('August', style: TextStyle(color: Colors.black, fontSize: 16),),
                            style: ButtonStyle(
                              overlayColor: MaterialStateProperty.all(Colors.transparent),
                            ),
                          ),    
                      ...
                      child: Row(
                        ...
                        children: [
                          TextButton.icon(
                            ...
                            label: const Text('2 Guests', style: TextStyle(color: Colors.black, fontSize: 16),),
                            style: ButtonStyle(
                              overlayColor: MaterialStateProperty.all(Colors.transparent),
                            ),
                          ),
                          ...
                          Container(
                            ...
                            child: Center(
                              child: ElevatedButton(
                                ...
                                child: const Text('Go to', style: TextStyle(fontSize: 16),)
                              )
                            ),
                          ),
                        ],
